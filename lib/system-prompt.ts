...
3. Fix broken or malformed markdown syntax
4. Fix encoding issues (HTML entities, weird characters)
5. Keep all meaningful article content and structure
6. If content appears to be mostly boilerplate/navigation with no main article, set isComplete to false
7. Ensure the article is readable and makes sense
